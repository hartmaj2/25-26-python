...
player_surf = pygame.image.load('Ukazky/david_ultra_hardcore/better_rocket_game.png')
player_surf = pygame.transform.scale_by(player_surf, 0.2)
player_rect = player_surf.get_rect()
player_rect.midbottom = (450,900)
player_speed = 0

asteroid_surf = pygame.image.load('Ukazky/david_ultra_hardcore/asteroid.png')
...
laser_surf = pygame.image.load('Ukazky/david_ultra_hardcore/plamenomet.png')
laser_surf = pygame.transform.scale_by(laser_surf, 1)
laser_rect = laser_surf.get_rect()

hvezda_surf = pygame.image.load('Ukazky/david_ultra_hardcore/hvezda.png')
...
enemy_surf = pygame.image.load('Ukazky/david_ultra_hardcore/nepritel.png')
enemy_surf = pygame.transform.scale_by(enemy_surf, 2)
enemy_rect = enemy_surf.get_rect()

shot_surf = pygame.image.load('Ukazky/david_ultra_hardcore/laser.png')
...
def asteroid_check_collision():
    ...
    if asteroid_rect.colliderect(player_rect):
        file = open('Ukazky/david_ultra_hardcore/highscore.txt','r')
        highscore = file.readline()
        file.close()
        if skore > int(highscore):
            file = open('Ukazky/david_ultra_hardcore/highscore.txt','w')
            highscore = skore
...
def sad_trombone():
    if sad_trombone_played == False:
        pygame.mixer.music.load('Ukazky/david_ultra_hardcore/sad trombone.mp3')
        pygame.mixer.music.play()
        pygame.event.wait(4000)

def play_music():
    pygame.mixer.music.load('Ukazky/david_ultra_hardcore/asteroidsong.mp3')
    pygame.mixer.music.play(-1)

def highscore_music():
    if highscore_music_played == False:
        pygame.mixer.music.load('Ukazky/david_ultra_hardcore/Celebration Sound Effect.mp3')
        pygame.mixer.music.play()
