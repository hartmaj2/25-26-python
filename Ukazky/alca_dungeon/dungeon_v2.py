...
pygame.init() 
icon = pygame.image.load("Ukazky/alca_dungeon/mob3.png")
...
songa = pygame.mixer.Sound("Ukazky/alca_dungeon/song.mp3")
songa.set_volume(0.5)
songa2 = pygame.mixer.Sound("Ukazky/alca_dungeon/song2.wav")
songa2.set_volume(0.2)
spawn = pygame.mixer.Sound("Ukazky/alca_dungeon/spawn.wav")
hitsound = pygame.mixer.Sound("Ukazky/alca_dungeon/hit.mp3")
...
def tisksklepu(lvl, x, y, kdemobove, barvymobu, blitbosse):
    hratspawn = False
    stena = pygame.image.load("Ukazky/alca_dungeon/stena.png")
    stena = pygame.transform.scale_by(stena, 2)
    chodba = pygame.image.load("Ukazky/alca_dungeon/chodba.png")
    chodba = pygame.transform.scale_by(chodba, 2)
    start = pygame.image.load("Ukazky/alca_dungeon/start.png")
    start = pygame.transform.scale_by(start, 2)
    cil = pygame.image.load("Ukazky/alca_dungeon/cil.png")
    cil = pygame.transform.scale_by(cil, 2)

    typek = pygame.image.load("Ukazky/alca_dungeon/typek.png")
    typek = pygame.transform.scale_by(typek, 2)

    mob1 = pygame.image.load("Ukazky/alca_dungeon/mob1.png")
    mob1 = pygame.transform.scale_by(mob1, 2)
    #mob1.fill("magenta")
    mob2 = pygame.image.load("Ukazky/alca_dungeon/mob2.png")
    mob2 = pygame.transform.scale_by(mob2, 2)
    #mob2.fill("cyan")
    mob3 = pygame.image.load("Ukazky/alca_dungeon/mob3.png")
    mob3 = pygame.transform.scale_by(mob3, 2)
    #mob3.fill("yellow")
    boss = pygame.image.load("Ukazky/alca_dungeon/boss.png")
...
def chozenisklepem(kamjit, lvl, stojimna, x, y, sila, magie, hp, mobhp, kdemobove, barvymobu):
    nedosteny = pygame.image.load("Ukazky/alca_dungeon/nechoddosteny.png")
    nedosteny = pygame.transform.scale_by(nedosteny, 5)
    
    stenawarning = pygame.image.load("Ukazky/alca_dungeon/stenawarning.png")
...
textlevo = pygame.image.load("Ukazky/alca_dungeon/levo.png")
textlevo = pygame.transform.scale_by(textlevo, 5)
#textlevo.fill("magenta")
texthore = pygame.image.load("Ukazky/alca_dungeon/hore.png")
texthore = pygame.transform.scale_by(texthore, 5)
#texthore.fill("cyan")
textpravo = pygame.image.load("Ukazky/alca_dungeon/pravo.png")
textpravo = pygame.transform.scale_by(textpravo, 5)
#textpravo.fill("yellow")
textdolu = pygame.image.load("Ukazky/alca_dungeon/dolu.png")
textdolu = pygame.transform.scale_by(textdolu, 5)
#textdolu.fill("white")

cernyctverec = pygame.image.load("Ukazky/alca_dungeon/cernyctverec.png") #prekryje predchozi sklep, nemazat !POTOM SE MU TAKY MUSI NASTAVIT TEXTURA POZADI!
cernyctverec = pygame.transform.scale_by(cernyctverec, 10)               
kontajner = pygame.image.load("Ukazky/alca_dungeon/kontajner.png")    #kontajner s poctem lvlu, hp, ...
kontajner = pygame.transform.scale_by(kontajner, 8)
#kontajner.fill("cyan")
hitdisabled = pygame.image.load("Ukazky/alca_dungeon/hitdisabled.png")
hitdisabled = pygame.transform.scale_by(hitdisabled, 5)
#hitdisabled.fill("gray")
hit = pygame.image.load("Ukazky/alca_dungeon/hit.png")
hit = pygame.transform.scale_by(hit, 5)
#hit.fill("white")
hitrect = hit.get_rect()

pozadi = pygame.image.load("Ukazky/alca_dungeon/pozadi.png")
pozadi = pygame.transform.scale_by(pozadi, 10)
umrelsiscreen = pygame.image.load("Ukazky/alca_dungeon/umrelsiscreen.png")
umrelsiscreen = pygame.transform.scale_by(umrelsiscreen, 10)

title = pygame.image.load("Ukazky/alca_dungeon/title.png")
...
font = pygame.font.Font("Ukazky/alca_dungeon/IMMORTAL.ttf", 30)
font2 = pygame.font.Font("Ukazky/alca_dungeon/IMMORTAL.ttf", 40)
font3 = pygame.font.Font("Ukazky/alca_dungeon/IMMORTAL.ttf", 100)
...
while True:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and levorect.collidepoint(pygame.mouse.get_pos()):
            kamjit = 0
            if hratspawn:
                print("Ukazky/alca_dungeon/mel by se hrat spawn.wav")
                print(hratspawn)
                # channel2.play(spawn)
                spawn.play()
